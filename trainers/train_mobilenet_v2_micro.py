...
from models.mobilenet_v2_micro import MobilenetV2Micro
from core.real_data_loader import create_real_data_loaders

def train_model():
    print("=" * 60)
    print(f"训练 MobilenetV2Micro 模型")
    print("=" * 60)
    ...
    for epoch in range(num_epochs):
        ...
        if val_acc > best_val_acc:
            ...
            checkpoint_path = f"checkpoints/mobilenet_v2_micro_{timestamp}_best.pth"
