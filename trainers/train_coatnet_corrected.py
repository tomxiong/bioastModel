#!/usr/bin/env python3
"""
Fixed Training Script for coatnet
Auto-generated with correct class name: CoAtNet
"""
...
try:
    ...
    print(f"Successfully imported CoAtNet from models.coatnet")
except ImportError as e:
    print(f"Import error: {e}")
    print(f"Trying alternative import methods...")
    try:
        import importlib.util
        spec = importlib.util.spec_from_file_location("coatnet", f"models/coatnet.py")
        module = importlib.util.module_from_spec(spec)
        spec.loader.exec_module(module)
        CoAtNet = getattr(module, "CoAtNet")
        print(f"Successfully imported CoAtNet using importlib")
...
def train_model():
    ...
    print(f"Starting training for coatnet (CoAtNet)")
    ...
    try:
        ...
        # Create model
        print(f"Creating model: CoAtNet")
        model = CoAtNet()
        ...
        for epoch in range(num_epochs):
            ...
            if val_acc > best_val_acc:
                ...
                checkpoint_path = f'checkpoints/coatnet_{timestamp}_best.pth'
                torch.save({
        ...
        print(f'Training completed for coatnet')
        print(f'Best validation accuracy: {best_val_acc:.2f}%')
        
        return True
        
    except Exception as e:
        print(f"Training failed for coatnet: {e}")
        import traceback
        traceback.print_exc()
        return False
...
if __name__ == "__main__":
    success = train_model()
    if success:
        print(f"✅ coatnet training completed successfully")
    else:
        print(f"❌ coatnet training failed")
        sys.exit(1)
