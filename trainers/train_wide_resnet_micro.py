...
from models.wide_resnet_micro import WideResnetMicro
from core.real_data_loader import create_real_data_loaders

def train_model():
    print("=" * 60)
    print(f"训练 WideResnetMicro 模型")
    print("=" * 60)
    ...
    for epoch in range(num_epochs):
        ...
        if val_acc > best_val_acc:
            ...
            checkpoint_path = f"checkpoints/wide_resnet_micro_{timestamp}_best.pth"
