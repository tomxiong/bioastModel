...
from models.vision_transformer_micro import VisionTransformerMicro
from core.real_data_loader import create_real_data_loaders

def train_model():
    print("=" * 60)
    print(f"训练 VisionTransformerMicro 模型")
    print("=" * 60)
    ...
    for epoch in range(num_epochs):
        ...
        if val_acc > best_val_acc:
            ...
            checkpoint_path = f"checkpoints/vision_transformer_micro_{timestamp}_best.pth"
