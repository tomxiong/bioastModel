#!/usr/bin/env python3
"""
Corrected Training Script for efficientnet_v2
...
def train_model():
    """Train the efficientnet_v2 model with corrected data loading"""
    print(f"🚀 Starting corrected training for efficientnet_v2")
    ...
    try:
        ...
        model = EfficientNetV2(num_classes=2, width_mult=1.0, depth_mult=1.0)
        ...
        try:
            ...
            if "efficientnet_v2" == "micro_vit" or "efficientnet_v2" == "vit_tiny":
                model = EfficientNetV2(num_classes=2)
            elif "efficientnet_v2" == "mnasnet":
                model = EfficientNetV2(1.0, num_classes=2)
            elif "efficientnet_v2" == "shufflenet_v2":
                model = EfficientNetV2([4, 8, 4], [24, 48, 96, 192, 1024], num_classes=2)
            elif "efficientnet_v2" == "densenet":
