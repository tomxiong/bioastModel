...
Auto-generated with correct class name: MBConvBlock
"""
...
# Import the model
try:
    from models.coatnet import MBConvBlock
    print(f"Successfully imported {class_name} from models.coatnet")
    ...
    try:
        ...
        MBConvBlock = getattr(module, "MBConvBlock")
...
def train_model():
    ...
    print(f"Starting training for coatnet ({class_name})")
