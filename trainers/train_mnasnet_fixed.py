#!/usr/bin/env python3
"""
Fixed Training Script for mnasnet
Class: MNASNet
...
try:
    ...
    print(f"✅ Successfully imported MNASNet from models.mnasnet")
except ImportError as e:
    print(f"❌ Import error: {e}")
    print(f"🔄 Trying alternative import methods...")
    try:
        import importlib.util
        spec = importlib.util.spec_from_file_location("mnasnet", f"models/mnasnet.py")
        module = importlib.util.module_from_spec(spec)
        spec.loader.exec_module(module)
        MNASNet = getattr(module, "MNASNet")
        print(f"✅ Successfully imported MNASNet using importlib")
...
def train_model():
    """Train the mnasnet model"""
    print(f"🚀 Starting training for mnasnet (MNASNet)")
    ...
    try:
        ...
        print(f"🏗️  Creating model: MNASNet")
        ...
        try:
            ...
            try:
                ...
                try:
                    model = MNASNet(num_classes=2, pretrained=False)
        ...
        for epoch in range(num_epochs):
            ...
            if val_acc > best_val_acc:
                ...
                checkpoint_path = f'checkpoints/mnasnet_{timestamp}_best.pth'
                torch.save({
        ...
        print(f'🎉 Training completed for mnasnet')
        print(f'🏆 Best validation accuracy: {best_val_acc:.2f}%')
        
        return True
        
    except Exception as e:
        print(f"❌ Training failed for mnasnet: {e}")
        traceback.print_exc()
        return False
...
if __name__ == "__main__":
    success = train_model()
    if success:
        print(f"✅ mnasnet training completed successfully")
    else:
        print(f"❌ mnasnet training failed")
        sys.exit(1)
