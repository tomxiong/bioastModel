#!/usr/bin/env python3
"""
DenseNetWrapper 训练脚本 - 使用真实生物医学数据集
"""
...
from models.densenet_wrapper import DenseNetWrapper
from core.real_data_loader import create_real_data_loaders

def train_model():
    print("=" * 60)
    print(f"训练 DenseNetWrapper 模型 - 使用真实数据集")
    print("=" * 60)
    ...
    for epoch in range(num_epochs):
        ...
        if val_acc > best_val_acc:
            ...
            checkpoint_path = f"checkpoints/densenet_wrapper_{timestamp}_best.pth"
