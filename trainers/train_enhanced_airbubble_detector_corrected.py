#!/usr/bin/env python3
"""
Corrected Training Script for enhanced_airbubble_detector
...
def train_model():
    """Train the enhanced_airbubble_detector model with corrected data loading"""
    print(f"🚀 Starting corrected training for enhanced_airbubble_detector")
    ...
    try:
        ...
        try:
            ...
            if "enhanced_airbubble_detector" == "micro_vit" or "enhanced_airbubble_detector" == "vit_tiny":
                model = EnhancedAirBubbleDetector(num_classes=2)
            elif "enhanced_airbubble_detector" == "mnasnet":
                model = EnhancedAirBubbleDetector(1.0, num_classes=2)
            elif "enhanced_airbubble_detector" == "shufflenet_v2":
                model = EnhancedAirBubbleDetector([4, 8, 4], [24, 48, 96, 192, 1024], num_classes=2)
            elif "enhanced_airbubble_detector" == "densenet":
