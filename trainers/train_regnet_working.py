#!/usr/bin/env python3
"""
Working Training Script for regnet
...
def train_model():
    """Train the regnet model"""
    print(f"🚀 Starting working training for regnet")
