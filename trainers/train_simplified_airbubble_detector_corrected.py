#!/usr/bin/env python3
"""
Corrected Training Script for simplified_airbubble_detector
...
def train_model():
    """Train the simplified_airbubble_detector model with corrected data loading"""
    print(f"🚀 Starting corrected training for simplified_airbubble_detector")
    ...
    try:
        ...
        try:
            ...
            if "simplified_airbubble_detector" == "micro_vit" or "simplified_airbubble_detector" == "vit_tiny":
                model = SimplifiedAirBubbleDetector(num_classes=2)
            elif "simplified_airbubble_detector" == "mnasnet":
                model = SimplifiedAirBubbleDetector(1.0, num_classes=2)
            elif "simplified_airbubble_detector" == "shufflenet_v2":
                model = SimplifiedAirBubbleDetector([4, 8, 4], [24, 48, 96, 192, 1024], num_classes=2)
            elif "simplified_airbubble_detector" == "densenet":
                from models.densenet import DenseNet
                model = DenseNet(num_classes=2)
            elif "simplified_airbubble_detector" == "mic_mobilenetv3":
