#!/usr/bin/env python3
"""
EfficientNet-B0-Micro 训练脚本 - 使用真实生物医学数据集
"""
...
def train_model():
    print("=" * 60)
    print(f"训练 EfficientNet-B0-Micro 模型 - 使用真实数据集")
    print("=" * 60)
    ...
    for epoch in range(num_epochs):
        ...
        if val_acc > best_val_acc:
            ...
            checkpoint_path = f"checkpoints/efficientnet_b0_micro_{timestamp}_best.pth"
    ...
    report_path = f"reports/efficientnet_b0_micro_{timestamp}_training.json"
    with open(report_path, 'w') as f:
        json.dump(report, f, indent=2)
    
    print(f"\n✅ EfficientNet-B0-Micro 训练完成!")
