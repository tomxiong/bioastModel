#!/usr/bin/env python3
"""
Working Training Script for simplified_airbubble_detector
...
def train_model():
    """Train the simplified_airbubble_detector model using working data loading pattern"""
    print(f"🚀 Starting working training for simplified_airbubble_detector")
    ...
    try:
        ...
        try:
            ...
            if "simplified_airbubble_detector" == "densenet":
