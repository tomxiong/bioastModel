#!/usr/bin/env python3
"""
Corrected Training Script for densenet
...
def train_model():
    """Train the densenet model with corrected data loading"""
    print(f"🚀 Starting corrected training for densenet")
    ...
    try:
        ...
        try:
            ...
            if "densenet" == "micro_vit" or "densenet" == "vit_tiny":
                model = DenseNet(num_classes=2)
            elif "densenet" == "mnasnet":
                model = DenseNet(1.0, num_classes=2)
            elif "densenet" == "shufflenet_v2":
                model = DenseNet([4, 8, 4], [24, 48, 96, 192, 1024], num_classes=2)
            elif "densenet" == "densenet":
                from models.densenet import DenseNet
                model = DenseNet(num_classes=2)
            elif "densenet" == "mic_mobilenetv3":
