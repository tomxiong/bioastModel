#!/usr/bin/env python3
"""
Fixed Training Script for shufflenet_v2
Class: ShuffleNetV2
...
try:
    ...
    print(f"✅ Successfully imported ShuffleNetV2 from models.shufflenet_v2")
except ImportError as e:
    print(f"❌ Import error: {e}")
    print(f"🔄 Trying alternative import methods...")
    try:
        import importlib.util
        spec = importlib.util.spec_from_file_location("shufflenet_v2", f"models/shufflenet_v2.py")
        module = importlib.util.module_from_spec(spec)
        spec.loader.exec_module(module)
        ShuffleNetV2 = getattr(module, "ShuffleNetV2")
        print(f"✅ Successfully imported ShuffleNetV2 using importlib")
...
def train_model():
    """Train the shufflenet_v2 model"""
    print(f"🚀 Starting training for shufflenet_v2 (ShuffleNetV2)")
    ...
    try:
        ...
        print(f"🏗️  Creating model: ShuffleNetV2")
        ...
        try:
            ...
            try:
                ...
                try:
                    model = ShuffleNetV2(num_classes=2, pretrained=False)
        ...
        for epoch in range(num_epochs):
            ...
            if val_acc > best_val_acc:
                ...
                checkpoint_path = f'checkpoints/shufflenet_v2_{timestamp}_best.pth'
                torch.save({
        ...
        print(f'🎉 Training completed for shufflenet_v2')
        print(f'🏆 Best validation accuracy: {best_val_acc:.2f}%')
        
        return True
        
    except Exception as e:
        print(f"❌ Training failed for shufflenet_v2: {e}")
        traceback.print_exc()
        return False
...
if __name__ == "__main__":
    success = train_model()
    if success:
        print(f"✅ shufflenet_v2 training completed successfully")
    else:
        print(f"❌ shufflenet_v2 training failed")
        sys.exit(1)
