...
from models.squeezenet_micro import SqueezenetMicro
from core.real_data_loader import create_real_data_loaders

def train_model():
    print("=" * 60)
    print(f"训练 SqueezenetMicro 模型")
    print("=" * 60)
    ...
    for epoch in range(num_epochs):
        ...
        if val_acc > best_val_acc:
            ...
            checkpoint_path = f"checkpoints/squeezenet_micro_{timestamp}_best.pth"
