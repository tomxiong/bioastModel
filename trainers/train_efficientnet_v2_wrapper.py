#!/usr/bin/env python3
"""
EfficientNetV2S 训练脚本 - 使用真实生物医学数据集
"""
...
def train_model():
    print("=" * 60)
    print(f"训练 EfficientNetV2S 模型 - 使用真实数据集")
    print("=" * 60)
    ...
    for epoch in range(num_epochs):
        ...
        if val_acc > best_val_acc:
            ...
            checkpoint_path = f"checkpoints/efficientnet_v2_wrapper_{timestamp}_best.pth"
