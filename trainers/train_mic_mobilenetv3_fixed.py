#!/usr/bin/env python3
"""
Fixed Training Script for mic_mobilenetv3
Class: HardSwish
...
# Import the model
try:
    from models.mic_mobilenetv3 import HardSwish
    print(f"✅ Successfully imported HardSwish from models.mic_mobilenetv3")
except ImportError as e:
    print(f"❌ Import error: {e}")
    print(f"🔄 Trying alternative import methods...")
    try:
        import importlib.util
        spec = importlib.util.spec_from_file_location("mic_mobilenetv3", f"models/mic_mobilenetv3.py")
...
def train_model():
    ...
    print(f"🚀 Starting training for mic_mobilenetv3 (HardSwish)")
    ...
    try:
        ...
        print(f'🎉 Training completed for mic_mobilenetv3')
        print(f'🏆 Best validation accuracy: {best_val_acc:.2f}%')
        
        return True
        
    except Exception as e:
        print(f"❌ Training failed for mic_mobilenetv3: {e}")
        traceback.print_exc()
        return False
...
if __name__ == "__main__":
    success = train_model()
    if success:
        print(f"✅ mic_mobilenetv3 training completed successfully")
    else:
        print(f"❌ mic_mobilenetv3 training failed")
        sys.exit(1)
