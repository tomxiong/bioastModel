#!/usr/bin/env python3
"""
ConvNext-Tiny 训练脚本 - 使用真实生物医学数据集
"""
...
def train_model():
    print("=" * 60)
    print(f"训练 ConvNext-Tiny 模型 - 使用真实数据集")
    print("=" * 60)
    ...
    # 创建模型
    try:
        model = ConvNextTiny(num_classes=2, pretrained=False, dropout_rate=0.2)
    ...
    report_path = f"reports/convnext_tiny_{timestamp}_training.json"
