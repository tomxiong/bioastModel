...
def evaluate_model():
    # 加载模型
    print('='*80)
    print('MobileNetV3 v0.10.0 综合性能评估')
    print('='*80)
    print('\n[1/6] 加载模型...')
    ...
    # 保存结果
    output_path = 'experiments/multilevel_mobilenetv3_v0.10.0/comprehensive_evaluation.json'
    with open(output_path, 'w', encoding='utf-8') as f:
        json.dump(results, f, indent=2, ensure_ascii=False)

    # 打印摘要
    print('\n' + '='*80)
    print('MobileNetV3 v0.10.0 综合评估摘要')
    print('='*80)
