...
def evaluate_model():
    # 加载模型
    print('加载 MobileNetV4 v0.11.0 模型...')
    ...
    # 保存结果
    output_path = 'experiments/multilevel_mobilenetv4_v0.11.0/test_results.json'
    with open(output_path, 'w') as f:
        json.dump(results, f, indent=2)

    # 打印关键指标
    print('\n' + '='*80)
    print('MobileNetV4 v0.11.0 测试结果 (Threshold 0.5)')
    print('='*80)
    print(f"\nGrowth Level:")
