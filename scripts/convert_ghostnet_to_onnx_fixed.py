...
def convert_ghostnet_to_onnx_fixed():
    """修复版GhostNet ONNX转换"""
    
    print("开始修复版GhostNet ONNX转换...")
    ...
    # 转换为ONNX - 使用更严格的参数
    onnx_path = "onnx_models/ghostnet_fixed.onnx"
    ...
    if all_passed and max_diff < 1e-4:
        ...
        # 替换原始文件
        import shutil
        shutil.move(onnx_path, "onnx_models/ghostnet.onnx")
        print("已替换原始ONNX文件")
...
if __name__ == "__main__":
    convert_ghostnet_to_onnx_fixed()